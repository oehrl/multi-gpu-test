...
MultiGPUTest-Linux-Debug:
	 $(PROJECTBUILD) MultiGPUTest Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MultiGPUTest-Linux-DebugGame:
	 $(PROJECTBUILD) MultiGPUTest Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MultiGPUTest-Linux-Shipping:
	 $(PROJECTBUILD) MultiGPUTest Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MultiGPUTest-Linux-Test:
	 $(PROJECTBUILD) MultiGPUTest Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MultiGPUTest:
	 $(PROJECTBUILD) MultiGPUTest Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

MultiGPUTestEditor-Linux-Debug:
	 $(PROJECTBUILD) MultiGPUTestEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MultiGPUTestEditor-Linux-DebugGame:
	 $(PROJECTBUILD) MultiGPUTestEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MultiGPUTestEditor-Linux-Shipping:
	 $(PROJECTBUILD) MultiGPUTestEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MultiGPUTestEditor-Linux-Test:
	 $(PROJECTBUILD) MultiGPUTestEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MultiGPUTestEditor:
	 $(PROJECTBUILD) MultiGPUTestEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
